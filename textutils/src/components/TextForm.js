...
export default function TextForm(props) { 
    ...
    return (
        ...
        <div style={{ color: props.mode === 'dark' ? 'white':'black' }}>
            ...
            <button  disabled={text.length===0} className='btn btn-primary mx-2' onClick={handleLoClick} >Convert to Lowecase</button>
            <button disabled={text.length===0} className='btn btn-primary mx-2' onClick={RemoveText} >Remove all</button>
